...
const translations = {
  'pt': {
    ...
    'Brasil': 'Brazil',
    'Mundo': 'World',
    'Pesquisar unidades ...': 'Search units or address...',
    ...
    'Mensagem': 'Message',
    'Enviar': 'Send',
    'Benefícios das Escolas do Cruzeiro': 'Benefits of Cruzeiro Schools',
    'Metodologia Exclusiva': 'Exclusive Methodology',
    'Tradição Vitoriosa': 'Winning Tradition',
    'Professores Qualificados': 'Qualified Teachers',
    'Desenvolvimento Integral': 'Integral Development',
    'Infraestrutura Completa': 'Complete Infrastructure',
    'Oportunidades Reais': 'Real Opportunities',
    'Categorias por Idade': 'Age Categories',
    'Iniciação': 'Initiation',
    'Aperfeiçoamento': 'Improvement',
    'Especialização': 'Specialization',
    'Nossas Unidades': 'Our Units',
    'Regiões': 'Regions',
    'Estados': 'States',
    'Cidades': 'Cities',
    'Limpar Filtros': 'Clear Filters',
    'Como Chegar': 'How to Get There',
    'Aula Experimental Gratuita': 'Free Trial Class',
    'Agende sua Aula Experimental': 'Schedule your Trial Class',
    'Nome Completo': 'Full Name',
    'Selecione o estado': 'Select state',
    'Primeiro selecione o estado': 'First select the state',
    'Primeiro selecione cidade e estado': 'First select city and state',
    'Observações': 'Observations',
    'Enviar pelo WhatsApp': 'Send via WhatsApp',
    'Voltar ao Início': 'Back to Home',
    'Seus dados estão seguros conosco': 'Your data is safe with us',
    'Seja um Licenciado Cruzeiro': 'Become a Cruzeiro Licensee',
    'Solicite Informações sobre Licenciamento': 'Request Licensing Information',
    'E-mail': 'Email',
    'Cidade de Interesse': 'City of Interest',
    'Bairro de Interesse': 'Neighborhood of Interest',
    'Experiência com Futebol': 'Football Experience',
    'Capacidade de Investimento': 'Investment Capacity',
...
function markElementsForTranslation() {
  const selectors = [
    'h1', 'h2', 'h3', 'h4', 'h5', 'h6',
    'p', 'span:not(.menu-icon):not(.filter-arrow)', 
    'a:not([href*="mailto"]):not([href*="tel"]):not([href*="whatsapp"]):not(.carousel-btn)', 
    'button:not([data-bs-dismiss]):not(.carousel-btn):not(.fechar-noticia):not(.filter-header)',
  ...
  selectors.forEach(selector => {
    document.querySelectorAll(selector).forEach(element => {
      if (element.textContent.trim() && 
          ...
          !element.classList.contains('filter-count') &&
          !element.classList.contains('filter-arrow')) {
